...
#define CMD_SET_USER_GPIO 0x104
...
#define MBX_CMD_SET_USB_POWER	__MBX_COMPOSE_MSG(MBX_SYSTEM, CMD_SET_USB_POWER)
#define MBX_CMD_SET_REMOTE	__MBX_COMPOSE_MSG(MBX_SYSTEM, CMD_SET_REMOTE)
#define MBX_CMD_SET_IR_PROTOCOL	__MBX_COMPOSE_MSG(MBX_SYSTEM, CMD_SET_IR_PROTOCOL)
#define MBX_CMD_SET_REMOTE_MASK	__MBX_COMPOSE_MSG(MBX_SYSTEM, CMD_SET_REMOTE_MASK)
#define MBX_CMD_SET_USER_GPIO	__MBX_COMPOSE_MSG(MBX_SYSTEM, CMD_SET_USER_GPIO)
#endif
